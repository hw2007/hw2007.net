...
if (backButtonMode) {
    document.getElementById("back_button_link").href = backButtonModes[backButtonMode][0] + ".html";
    document.getElementById("back_button_text").textContent = "<< Back to " + backButtonModes[backButtonMode][1];
}
